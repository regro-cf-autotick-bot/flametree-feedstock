...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flametree-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12294&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flametree-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flametree` can be installed with:

```
conda install flametree
```

It is possible to list all of the versions of `flametree` available on your platform with:
